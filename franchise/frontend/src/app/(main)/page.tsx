...
import SVDashboard from '@/components/dashboard/SVDashboard'; // Imported new component
...
export default function Home() {
  ...
  const [debugSVMode, setDebugSVMode] = useState(false);
  ...
  return (
    <>
      <div className="fixed bottom-4 right-4 z-50">
        <button
          onClick={() => setDebugSVMode(!debugSVMode)}
          className="bg-gray-900 text-white text-xs px-3 py-1.5 rounded-full shadow-lg hover:bg-black opacity-50 hover:opacity-100 transition-opacity"
        >
          {debugSVMode ? 'Exit Detail View' : 'View SV Dashboard'}
        </button>
      </div>
