    ...
    async rewrites() {
        return [
            ...
            // SV QSC Endpoints (No /api prefix in Spring)
            {
                ...
                destination: 'http://43.200.3.26:8080/qsc/inspection/new',
            },
            {
                source: '/api/qsc/templates/:id',
                destination: 'http://43.200.3.26:8080/qsc/templates/:id',
            },
            {
                source: '/api/qsc/inspections/:path*',
                destination: 'http://43.200.3.26:8080/qsc/inspections/:path*',
            },
            {
                source: '/api/qsc/stores/test/:id',
                destination: 'http://43.200.3.26:8080/qsc/stores/test/:id',
            },
